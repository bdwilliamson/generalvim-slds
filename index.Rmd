...
date: "24 February, 2022 <br> <a href = 'https://bdwilliamson.github.io/talks' style = 'color: white;'>https://bdwilliamson.github.io/talks</a>"
output:
...
.pull-left[
```{r two-cultures, echo = FALSE, out.width="450px", fig.align="center"}
knitr::include_graphics("img/breiman_two-cultures.png")
```
]
...
.pull-right[
```{r obs-studies-two-cultures, echo = FALSE, out.width="450px", fig.align="center"}
knitr::include_graphics("img/obs-studies_two-cultures.png")
```
...
.pull-left[
```{r sl-perf, echo = FALSE, out.width = "100%", fig.align = "center"}
knitr::include_graphics("img/sl_perf_ic50.censored.png")
```
]
--

.pull-right[
```{r sl-roc, echo = FALSE, out.width = "600px", fig.align = "center"}
knitr::include_graphics("img/sl_roc_ic50.censored.png")
```
]
---
...
```{r vrc01-env-roc, echo = FALSE, out.width = "60%", fig.align = "center"}
knitr::include_graphics("img/ROC_curve_with_Env_inset_v2.png")
```
...
`r icons::fontawesome('github')` https://github.com/bdwilliamson
`r icons::fontawesome('globe')` https://bdwilliamson.github.io
